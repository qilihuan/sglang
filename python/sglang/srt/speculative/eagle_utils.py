...
def eagle_sample(
    ...
    if sampling_info.is_all_greedy or _is_cpu or _is_npu or _is_hip or _is_xpu:
        ...
        if _is_hip:
            ...
            # different number of drafts, desynchronize the committed seq_lens,
            # and deadlock the next TP collective. Broadcast from rank 0 to
            # ensure consistency, the same way the sampling branch below does.
            tp_group = (
